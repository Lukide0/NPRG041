...
#include <koterm/dom/input/Radiobox.h>
...
template <typename T> using radiobox_t = koterm::dom::input::Radiobox<T>;
...
int main() {
    ...
    using option_t = radiobox_t<int>::Option;
    ...
    auto input = radiobox_t<int>::create(screen.get(), options);
